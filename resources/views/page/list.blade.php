...
<div class="container">
  ...
  <div class="row">
    <table class="table table-striped text-center table-bordered tablesorter" id="myTable">
      <thead>
        <tr>
          <th scope="col" id="sort">ID</th>
          <th scope="col" id="sort">商品名</th>
          <th scope="col" id="sort">商品画像</th>
          <th scope="col" id="sort">価格</th>
          <th scope="col" id="sort">在庫</th>
          <th scope="col" id="sort">メーカー名</th>
